...
import { TipoReqBodyAbrigo } from "../../types/TipoAbrigo";
...
const schemaBodyValidator: yup.ObjectSchema<
    Omit<TipoReqBodyAbrigo, "endereco">
  > = yup.object({
...
const middlewareValidatorBodyAbrigo = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export { middlewareValidatorBodyAbrigo };
